/* Auto-generated by genmsg_cpp for file /home/ludo/workspace/rosbuild_ws/humanoid_stack/humanoid_msgs/humanoid_nav_msgs/msg/ExecFootstepsActionFeedback.msg */
...
struct ExecFootstepsActionFeedback_ {
  ...
  typedef  ::humanoid_nav_msgs::ExecFootstepsFeedback_<ContainerAllocator>  _feedback_type;
   ::humanoid_nav_msgs::ExecFootstepsFeedback_<ContainerAllocator>  feedback;
...
}; // struct ExecFootstepsActionFeedback
...
{
template<class ContainerAllocator> struct IsMessage< ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::humanoid_nav_msgs::ExecFootstepsActionFeedback_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
