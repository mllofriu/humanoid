/* Auto-generated by genmsg_cpp for file /home/ludo/workspace/rosbuild_ws/humanoid_stack/humanoid_msgs/humanoid_nav_msgs/msg/ExecFootstepsActionGoal.msg */
...
struct ExecFootstepsActionGoal_ {
  ...
  typedef  ::humanoid_nav_msgs::ExecFootstepsGoal_<ContainerAllocator>  _goal_type;
   ::humanoid_nav_msgs::ExecFootstepsGoal_<ContainerAllocator>  goal;
...
}; // struct ExecFootstepsActionGoal
...
{
template<class ContainerAllocator> struct IsMessage< ::humanoid_nav_msgs::ExecFootstepsActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::humanoid_nav_msgs::ExecFootstepsActionGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::humanoid_nav_msgs::ExecFootstepsActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::humanoid_nav_msgs::ExecFootstepsActionGoal_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
