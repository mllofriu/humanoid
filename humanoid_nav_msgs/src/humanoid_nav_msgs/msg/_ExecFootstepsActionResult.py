"""autogenerated by genpy from humanoid_nav_msgs/ExecFootstepsActionResult.msg. Do not edit."""
import sys
...
class ExecFootstepsActionResult(genpy.Message):
  _md5sum = "66fa71246c6848e28e972f9031bbbddc"
  _type = "humanoid_nav_msgs/ExecFootstepsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','humanoid_nav_msgs/ExecFootstepsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = humanoid_nav_msgs.msg.ExecFootstepsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = humanoid_nav_msgs.msg.ExecFootstepsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.executed_footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.executed_footsteps:
        _v1 = val1.pose
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.result.executed_footsteps = []
      for i in range(0, length):
        ...
        self.result.executed_footsteps.append(val1)
      return self
