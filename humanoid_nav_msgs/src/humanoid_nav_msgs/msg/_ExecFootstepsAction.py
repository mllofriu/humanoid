"""autogenerated by genpy from humanoid_nav_msgs/ExecFootstepsAction.msg. Do not edit."""
import sys
...
class ExecFootstepsAction(genpy.Message):
  _md5sum = "1a2c4888b786ce4d1be346c228ea5a28"
  _type = "humanoid_nav_msgs/ExecFootstepsAction"
...
"""
  ...
  _slot_types = ['humanoid_nav_msgs/ExecFootstepsActionGoal','humanoid_nav_msgs/ExecFootstepsActionResult','humanoid_nav_msgs/ExecFootstepsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = humanoid_nav_msgs.msg.ExecFootstepsActionGoal()
      if self.action_result is None:
        self.action_result = humanoid_nav_msgs.msg.ExecFootstepsActionResult()
      if self.action_feedback is None:
        self.action_feedback = humanoid_nav_msgs.msg.ExecFootstepsActionFeedback()
    else:
      self.action_goal = humanoid_nav_msgs.msg.ExecFootstepsActionGoal()
      self.action_result = humanoid_nav_msgs.msg.ExecFootstepsActionResult()
      self.action_feedback = humanoid_nav_msgs.msg.ExecFootstepsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.footsteps:
        _v1 = val1.pose
        _x = _v1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.theta))
        buff.write(_struct_B.pack(val1.leg))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.feedback_frequency, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.executed_footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.executed_footsteps:
        _v2 = val1.pose
        _x = _v2
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.theta))
        buff.write(_struct_B.pack(val1.leg))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.executed_footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.executed_footsteps:
        _v3 = val1.pose
        _x = _v3
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.theta))
        buff.write(_struct_B.pack(val1.leg))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.footsteps = []
      for i in range(0, length):
        ...
        self.action_goal.goal.footsteps.append(val1)
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.feedback_frequency, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.executed_footsteps = []
      for i in range(0, length):
        val1 = humanoid_nav_msgs.msg.StepTarget()
        _v5 = val1.pose
        _x = _v5
        ...
        (val1.leg,) = _struct_B.unpack(str[start:end])
        self.action_result.result.executed_footsteps.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.executed_footsteps = []
      for i in range(0, length):
        val1 = humanoid_nav_msgs.msg.StepTarget()
        _v6 = val1.pose
        _x = _v6
        ...
        (val1.leg,) = _struct_B.unpack(str[start:end])
        self.action_feedback.feedback.executed_footsteps.append(val1)
      return self
