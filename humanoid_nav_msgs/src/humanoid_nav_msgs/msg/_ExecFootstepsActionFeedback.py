"""autogenerated by genpy from humanoid_nav_msgs/ExecFootstepsActionFeedback.msg. Do not edit."""
import sys
...
class ExecFootstepsActionFeedback(genpy.Message):
  _md5sum = "01da67223a0592f0de40186a03f441ff"
  _type = "humanoid_nav_msgs/ExecFootstepsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','humanoid_nav_msgs/ExecFootstepsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = humanoid_nav_msgs.msg.ExecFootstepsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = humanoid_nav_msgs.msg.ExecFootstepsFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.feedback.executed_footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.executed_footsteps:
        _v1 = val1.pose
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.executed_footsteps = []
      for i in range(0, length):
        ...
        self.feedback.executed_footsteps.append(val1)
      return self
