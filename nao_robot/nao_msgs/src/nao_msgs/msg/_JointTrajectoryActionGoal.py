"""autogenerated by genpy from nao_msgs/JointTrajectoryActionGoal.msg. Do not edit."""
import sys
...
class JointTrajectoryActionGoal(genpy.Message):
  _md5sum = "3273243339f8ad806de69e2c87c1e17c"
  _type = "nao_msgs/JointTrajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','nao_msgs/JointTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = nao_msgs.msg.JointTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = nao_msgs.msg.JointTrajectoryGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.goal.relative))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.relative,) = _struct_B.unpack(str[start:end])
      return self
