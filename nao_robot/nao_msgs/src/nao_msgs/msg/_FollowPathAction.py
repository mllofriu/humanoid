"""autogenerated by genpy from nao_msgs/FollowPathAction.msg. Do not edit."""
import sys
...
class FollowPathAction(genpy.Message):
  ...
  _type = "nao_msgs/FollowPathAction"
...
"""
  ...
  _slot_types = ['nao_msgs/FollowPathActionGoal','nao_msgs/FollowPathActionResult','nao_msgs/FollowPathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = nao_msgs.msg.FollowPathActionGoal()
      if self.action_result is None:
        self.action_result = nao_msgs.msg.FollowPathActionResult()
      if self.action_feedback is None:
        self.action_feedback = nao_msgs.msg.FollowPathActionFeedback()
    else:
      self.action_goal = nao_msgs.msg.FollowPathActionGoal()
      self.action_result = nao_msgs.msg.FollowPathActionResult()
      self.action_feedback = nao_msgs.msg.FollowPathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.path.header.seq, _x.action_goal.goal.path.header.stamp.secs, _x.action_goal.goal.path.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.action_feedback.feedback.index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.path.header.seq, _x.action_goal.goal.path.header.stamp.secs, _x.action_goal.goal.path.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.index,) = _struct_I.unpack(str[start:end])
      return self
