"""autogenerated by genpy from nao_msgs/FollowPathActionFeedback.msg. Do not edit."""
import sys
...
class FollowPathActionFeedback(genpy.Message):
  _md5sum = "dfaee912e03af794d99d2a72e37fc3e5"
  _type = "nao_msgs/FollowPathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nao_msgs/FollowPathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowPathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = nao_msgs.msg.FollowPathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nao_msgs.msg.FollowPathFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.feedback.index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.index,) = _struct_I.unpack(str[start:end])
      return self
