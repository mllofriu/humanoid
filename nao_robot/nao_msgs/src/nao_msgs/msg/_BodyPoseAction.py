"""autogenerated by genpy from nao_msgs/BodyPoseAction.msg. Do not edit."""
import sys
...
class BodyPoseAction(genpy.Message):
  _md5sum = "bc58fd1218bb64624b76dca7ad8a5a81"
  _type = "nao_msgs/BodyPoseAction"
...
"""
  ...
  _slot_types = ['nao_msgs/BodyPoseActionGoal','nao_msgs/BodyPoseActionResult','nao_msgs/BodyPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BodyPoseAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = nao_msgs.msg.BodyPoseActionGoal()
      if self.action_result is None:
        self.action_result = nao_msgs.msg.BodyPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = nao_msgs.msg.BodyPoseActionFeedback()
    else:
      self.action_goal = nao_msgs.msg.BodyPoseActionGoal()
      self.action_result = nao_msgs.msg.BodyPoseActionResult()
      self.action_feedback = nao_msgs.msg.BodyPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.pose_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pose_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.pose_name = str[start:end]
      _x = self
      start = end
      end += 12
