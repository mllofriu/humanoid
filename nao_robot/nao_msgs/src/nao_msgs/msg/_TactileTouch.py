"""autogenerated by genpy from nao_msgs/TactileTouch.msg. Do not edit."""
import sys
...
class TactileTouch(genpy.Message):
  _md5sum = "b75165bf9dfed26d50ad4e3162304225"
  _type = "nao_msgs/TactileTouch"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# A message for Nao's tactile interface (toucht buttons on the head)
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TactileTouch, self).__init__(*args, **kwds)
