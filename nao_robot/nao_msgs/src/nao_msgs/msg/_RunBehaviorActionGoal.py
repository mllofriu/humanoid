"""autogenerated by genpy from nao_msgs/RunBehaviorActionGoal.msg. Do not edit."""
import sys
...
class RunBehaviorActionGoal(genpy.Message):
  _md5sum = "75f2114406eede7b6b30792461853435"
  _type = "nao_msgs/RunBehaviorActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','nao_msgs/RunBehaviorGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunBehaviorActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = nao_msgs.msg.RunBehaviorGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = nao_msgs.msg.RunBehaviorGoal()
