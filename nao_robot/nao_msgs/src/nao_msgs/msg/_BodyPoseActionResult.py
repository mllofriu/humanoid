...
class BodyPoseActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "nao_msgs/BodyPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nao_msgs/BodyPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BodyPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nao_msgs.msg.BodyPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nao_msgs.msg.BodyPoseResult()
