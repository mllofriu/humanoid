"""autogenerated by genpy from nao_msgs/JointAngleTrajectory.msg. Do not edit."""
import sys
...
class JointAngleTrajectory(genpy.Message):
  _md5sum = "5ec9aa90e61498421ea53db10da7f8dd"
  _type = "nao_msgs/JointAngleTrajectory"
...
"""
  __slots__ = ['header','joint_names','joint_angles','times','relative']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,joint_names,joint_angles,times,relative
    ...
    """
    if args or kwds:
      super(JointAngleTrajectory, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.relative))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.relative,) = _struct_B.unpack(str[start:end])
      return self
