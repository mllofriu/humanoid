"""autogenerated by genpy from nao_msgs/RunBehaviorActionFeedback.msg. Do not edit."""
import sys
...
class RunBehaviorActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "nao_msgs/RunBehaviorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nao_msgs/RunBehaviorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunBehaviorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = nao_msgs.msg.RunBehaviorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nao_msgs.msg.RunBehaviorFeedback()
