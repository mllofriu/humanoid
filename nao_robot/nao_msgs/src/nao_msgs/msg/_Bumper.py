"""autogenerated by genpy from nao_msgs/Bumper.msg. Do not edit."""
import sys
...
class Bumper(genpy.Message):
  _md5sum = "4d423b2a165337e812d1b5a1cbab6b8d"
  _type = "nao_msgs/Bumper"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# A message for Nao's bumpers on the feet
