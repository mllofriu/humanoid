...
#        self.set_camera_info_service_ = rospy.Service('set_camera_info', SetCameraInfo, self.set_camera_info)
        ...
        self.tCIM = CameraInfoManager('narrow_stereo/top', topCamParamsURL,'/nao_cam/top/')
        self.bCIM = CameraInfoManager('narrow_stereo/bottom', bottomCamParamsURL,'/nao_cam/bottom/')
